...
| Merkmal | Navinci |
| --- | --- |
| BLE-Verbindung | CSC-Sensor (Bluetooth SIG Standard) |
| Geschwindigkeit | CSC Wheel Revolution Data |
| Trittfrequenz | CSC Crank Data |
| Höhenmessung | Barometer + GPS/Kalman-Fallback |
| Höhenmeter ↑ | Live + Verlauf + CSV |
| Navigation | OsmAnd-Button mit Split-Screen |
| Hintergrundbetrieb | Foreground Service (GPS + Barometer) |